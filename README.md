...
The project is also my attempt on project based learning and to solve a problem in my home country, Nigeria. I aim to learn basic backend concepts as I implement them on this project. Which are;
